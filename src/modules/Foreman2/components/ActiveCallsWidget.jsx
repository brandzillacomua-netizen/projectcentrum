...
export default function ActiveCallsWidget({ activeCalls, machines, onResolveCall }) {
  if (!activeCalls || activeCalls.length === 0) return null

  return (
    <div style={{ background: 'rgba(239, 68, 68, 0.05)', border: '1px solid rgba(239, 68, 68, 0.15)', borderRadius: '16px', padding: '15px 20px', marginBottom: '20px', margin: '20px 20px 0' }}>
