    ...
    <div style={{ background: '#050505', minHeight: '100vh', color: '#fff', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '30px', maxWidth: '1400px', margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-start', gap: '12px', marginBottom: '25px', flexWrap: 'wrap' }}>
          ...
          {!showReasonCatalog && <div className="vkya-search-box" style={{ display: 'flex', alignItems: 'center', background: '#0a0a0a', border: '1px solid #333', borderRadius: '14px', overflow: 'hidden' }}>
            <input
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '20px', marginBottom: '40px' }}>
          {[
            ...
            <div key={s.label} 
              ...
              style={{ 
                background: viewingCategory === s.cat ? `${s.color}18` : 'rgba(20,20,20,0.6)', 
              ...
              <div className="vkya-card-desc" style={{ fontSize: '0.65rem', marginTop: '10px', fontWeight: 600 }}>{s.desc}</div>
