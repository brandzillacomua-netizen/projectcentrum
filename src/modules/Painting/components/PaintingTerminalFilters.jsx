...
export default function PaintingTerminalFilters({
  filterMode,
  setFilterMode,
  waitingCards,
  inWorkCards
  ...
  return (
    <div style={{ padding: '14px 20px', background: 'rgba(255,255,255,0.01)', borderBottom: '1px solid var(--glass-border, rgba(255,255,255,0.03))', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
      ...
      <div style={{ fontSize: '0.65rem', color: 'var(--text-muted, #555)', fontWeight: 700, textTransform: 'uppercase' }} className="stage-label-title">Черга Фарбування</div>
    </div>
  )
}
