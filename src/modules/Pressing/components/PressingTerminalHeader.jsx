...
export default function PressingTerminalHeader({
  currentTime,
  selectedShift,
  setSelectedShift
}) {
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px', minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            <h1 style={{ fontSize: '0.95rem', fontWeight: 950, letterSpacing: '0.3px', textTransform: 'uppercase', margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', color: 'var(--text, #fff)' }}>ЕКРАН ПРЕСУВАННЯ</h1>
