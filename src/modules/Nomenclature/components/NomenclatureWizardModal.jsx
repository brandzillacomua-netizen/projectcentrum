            ...
            {wizardRuleType === 'frame_part' && (
              <>
                ...
                <div style={{ background: 'rgba(255,144,0,0.05)', border: '1px solid rgba(255,144,0,0.25)', borderRadius: '16px', padding: '16px' }}>
                  ...
                  <div>
                    <label style={{ fontSize: '0.72rem', color: 'var(--text-muted, #64748b)', fontWeight: 800, textTransform: 'uppercase', marginBottom: '6px', display: 'block' }}>
                      НОРМА ДЕТАЛЕЙ З 1 ЛИСТА (ШТ/Л) *
                    </label>
                    <input 
                      type="number" 
                      min="1"
