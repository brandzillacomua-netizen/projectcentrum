      ...
      <section className="glass-panel" style={{ background: '#0e0e11', padding: '28px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.04)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)', position: 'sticky', top: '24px' }}>
        ...
        <form onSubmit={handleSaveUser} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '10px' }}>
            ...
            {userForm.id && (
              <button type="button" 
                onClick={() => setUserForm({ id: null, login: '', password: '', first_name: '', last_name: '', position: companyPositions?.[0]?.name || 'Оператор', department: companyStructure?.[0]?.name || 'Цех №1', shift: 'Без зміни', access_rights: { crm: false, crm_clients: false, dashboard: false, foreman_dashboard: false, manager: false, master: false, warehouse: false, preparation_dashboard: false, engineer: false, director: false, foreman: false, foreman2: false, operator: true, prep_terminal: false, shipping: false, supply: false, procurement: false, nomenclature: false, nomenclature_v2: false, shop2: false, shop2_card_gen: false, machines: false, settings: false, kanban: false, reports: false, tumbling_terminal: false, tumbling_dashboard: false, reception_terminal: false, sorting_terminal: false, painting_terminal: false, pressing_terminal: false } })}
