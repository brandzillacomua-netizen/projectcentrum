...
export default function SortingQRScannerModal({
  isScanning,
  setIsScanning,
  showManualInput,
  setShowManualInput,
  ...
  return (
    <div className="terminal-modal-overlay qr-modal-overlay" style={{ position: 'fixed', inset: 0, background: '#000', zIndex: 10001, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', padding: '20px' }}>
