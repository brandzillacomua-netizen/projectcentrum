  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
      ...
      <div style={{ background: '#111', padding: '25px', borderRadius: '16px', border: '1px solid #222' }}>
        <h3 style={{ margin: '0 0 15px 0', fontSize: '1.1rem', color: '#ff9000', fontWeight: 900 }}>✚ Створити новий тип фрези</h3>
        <form onSubmit={handleAddCutterType} style={{ display: 'flex', gap: '15px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
          ...
          <button 
            type="submit" 
            disabled={saving}
            style={{ padding: '12px 24px', background: 'linear-gradient(135deg, #ff9000, #ff6a00)', color: '#000', border: 'none', borderRadius: '8px', fontWeight: 900, cursor: 'pointer', fontSize: '0.85rem' }}
          >
              ...
              return (
                <div key={c.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#0a0a0a', padding: '12px 15px', borderRadius: '10px', border: '1px solid #222' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '0.72rem', color: '#666', marginTop: '2px' }}>Діаметр: {c.material_type || '—'} мм | Прив'язано фрез: <span style={{ color: '#ff9000', fontWeight: 800 }}>{assignedCount}</span></div>
                  </div>
                  <button 
            ...
            {physicalCutters.map(p => (
              <div key={p.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#0a0a0a', padding: '12px 15px', borderRadius: '10px', border: '1px solid #222', gap: '15px' }}>
                ...
                <select 
                  ...
                  style={{ width: '180px', padding: '8px', background: '#000', border: '1px solid #333', color: p.characteristic ? '#ff9000' : '#888', borderRadius: '6px', fontSize: '0.78rem', fontWeight: p.characteristic ? 800 : 500 }}
                >
