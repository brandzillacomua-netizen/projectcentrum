...
export default function TumblingCompleteModal({
  showCompleteModal,
      ...
      <div style={{ background: 'var(--card-bg, #0e0e11)', width: '100%', maxWidth: '420px', maxHeight: 'calc(100vh - 40px)', borderRadius: '28px', border: '1px solid rgba(16,185,129,0.2)', overflowY: 'auto', boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
        ...
        <div style={{ padding: '20px 24px', background: 'rgba(255,255,255,0.01)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--glass-border, rgba(255,255,255,0.04))' }}>
          <div>
            ...
            <div style={{ fontSize: '0.62rem', color: 'var(--text-muted, #555)', marginTop: '2px', fontWeight: 800 }}>
          ...
          <button
            ...
            style={{ background: 'none', border: 'none', color: 'var(--text-muted, #555)', cursor: 'pointer', transition: '0.2s' }}
        ...
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-muted, #888)', fontWeight: 800, textTransform: 'uppercase', marginBottom: '6px' }}>Готових деталей</label>
              <input
                type="number"
                min="0"
