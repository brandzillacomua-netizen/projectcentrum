  ...
  <table class="data-table">
    ...
    <tbody>
      <tr>
        ...
        <td>Спільний секрет <code>x-mes-secret: REVOKED_MES_SECRET_DO_NOT_USE</code> вшито у фронтенд-бандл. Будь-хто через F12 може скопіювати ключ і виконати запит повз UI.</td>
