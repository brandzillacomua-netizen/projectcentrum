...
const patch = (filePath, replacements) => {
  ...
  for (const [from, to] of replacements) {
    if (content.includes(from)) {
      ...
      console.log(`  ⚠️  NOT FOUND: "${from.substring(0,60).trim()}"`);
    }
  }
...
// =====================================================================
// useWarehouse.js — головне: nextWhConf тепер рядки
// =====================================================================
console.log('\n📄 useWarehouse.js');
patch('a:/centrum/src/contexts/useWarehouse.js', [
  [
...
// =====================================================================
// useProduction.js — всі warehouse_conf: true/false
// =====================================================================
console.log('\n📄 useProduction.js');
patch('a:/centrum/src/contexts/useProduction.js', [
  ['warehouse_conf: true,',  "warehouse_conf: 'true',"],
  ['warehouse_conf: false,', "warehouse_conf: 'false',"],
  ['warehouse_conf: isAllFromBZ ? true : false', "warehouse_conf: isAllFromBZ ? 'true' : 'false'"],
  ['warehouse_conf: true }', "warehouse_conf: 'true' }"],
  // setTasks local update
  ['warehouse_conf: true })', "warehouse_conf: 'true' })"],
]);
...
// =====================================================================
console.log('\n📄 requestBuilder.js');
patch('a:/centrum/src/services/requestBuilder.js', [
  ['warehouse_conf: true',  "warehouse_conf: 'true'"],
  ['warehouse_conf: false', "warehouse_conf: 'false'"],
]);
...
patch('a:/centrum/src/modules/ForemanWorkplace.jsx', [
  // shouldAutoReserve truthy checks → explicit
  [
  ...
  // relevantTasks filter — already has 'partial' check, just fix === true
  ["t.warehouse_conf === true", "t.warehouse_conf === 'true'"],
]);
...
patch('a:/centrum/src/modules/WarehouseModuleV2.jsx', [
  // pendingRequests filter: виключати тільки повністю підтверджені
  [
