...
// 2. Remove countAsProduced from the bottom
const bottomMatch = `  // 0. Per-task readiness: all Shop-1 cards produced >= need
  ...
  // Будь-який проміжний стан (at-buffer, in-progress) — ще НЕ виробено
  const countAsProduced = (card) => {
