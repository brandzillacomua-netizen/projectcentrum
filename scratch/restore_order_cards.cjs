...
// Logged cards from task-1842.log
...
async function run() {
  ...
  for (const c of cardsToRestore) {
    ...
    else console.log(`Failed to restore card ${c.id}: status ${status}`);
  }

  console.log(`Successfully restored ${restoredCount} work cards for active orders #260826-1 and #260827-1.`);
}
